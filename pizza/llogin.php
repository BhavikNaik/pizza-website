    ...
    <body>
        ...
        <br><br>
          <div class="container register">
            ...
            <div class="col-md-6">
            &emsp;&emsp;<?php if (isset($_GET['error'])) { ?>
                <p class="error"><?php echo $_GET['error']; ?></p>
            <?php } ?>
            <div class="form-group">
            <input type="text" class="form-control" id="name" name="name" placeholder="Username *" value="<?php if(isset($_COOKIE['usernamec'])) {echo $_COOKIE['usernamec']; }  ?>">
            </div>
            <div class="form-group">
            <input type="password" class="form-control" id="pass" name="pass" placeholder="Password *" value="<?php if(isset($_COOKIE['passwordc'])) {echo $_COOKIE['passwordc']; }  ?>">
            </div>
            <div class="form-group">
            <input type="checkbox" name="rememberme"> Remember Me
            </div><br>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
            ...
            <p>&emsp;&emsp;Dont have an Account? <a href="register.php">SIGN UP</a></p><br>
            </div>
            </div>
            </div>
